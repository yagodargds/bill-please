    ...
    public LoaderResult load(CancellationSignal signal) {
        ...
        if(!BillList.getInstance().isLoaded()) {
            ...
            if (opResult.isSuccessful()) {
                ...
                OperationResult<List<BillOrder>> loadOpResult = BillOrderRepository.getInstance().loadGroupList(newBillId);
                loaderResult.setData(new Object[]{opResult, loadOpResult}); //TODO array of data
                if (loadOpResult.isSuccessful()) {
